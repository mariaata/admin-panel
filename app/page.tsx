...
return {
  ...
  imageUrl: (caption.images as any)?.url || null,  // ✅ Cast to any or use proper type
  score,
  totalVotes,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        {/* ✅ UPDATED: Top Rated Captions with Images */}
            ...
            {captionsWithScores.map((caption, index) => (
              <div key={caption.id} className="bg-white/5 rounded-lg p-4 border border-white/10">
                <div className="flex items-start gap-4">
                  ...
                  {caption.imageUrl && (
                    <div className="w-24 h-24 rounded-lg overflow-hidden bg-black border border-white/10 flex-shrink-0">
                      <img 
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
  ...
  <Link href="/humor-flavor-mix">
    <div className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition cursor-pointer hover:scale-105">
      ...
      <p className="text-gray-400 text-sm">Manage flavor mix</p>
    </div>
  </Link>
</div>
